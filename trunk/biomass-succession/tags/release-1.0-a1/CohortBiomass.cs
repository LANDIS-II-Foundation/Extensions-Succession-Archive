...
namespace Landis.Biomass.Succession
{
        ...
        : LivingBiomass, Biomass.ICalculator
    {
                                 ...
                                 int        prevYearSiteMortality)
        {
            ...
            //  mortality to prevent the over-estimation of mortality.
            M_BIO_ij -= M_AGE_ij;
        ...
        private void ComputeAgeMortality(int age)
        {
            ...
            M_AGE_ij = B_ij * (Math.Exp(age / max_age * d) / Math.Exp(d));
        }
        ...
        private void UpdateDeadBiomass()
        {
            ...
            DeadBiomass.UpdateWoodyDeadPool(WoodyDecayRate[species], M_wood);
            DeadBiomass.UpdateNonwoodyDeadPool(LeafLitterDecayRate[species][ecoregion], M_nonwood);
