    ...
    public class SpeciesData
    {
        ...
        public static void ChangeDynamicParameters(int year)
        {
            ...
            if(DynamicInputs.AllData.ContainsKey(year))
            {
                ...
                EstablishProbability = Util.CreateSpeciesEcoregionParm<double>(Model.Core.Species, Model.Core.Ecoregions);
                ANPP_MAX_Spp         = Util.CreateSpeciesEcoregionParm<int>(Model.Core.Species, Model.Core.Ecoregions);
                B_MAX_Spp            = Util.CreateSpeciesEcoregionParm<int>(Model.Core.Species, Model.Core.Ecoregions);
