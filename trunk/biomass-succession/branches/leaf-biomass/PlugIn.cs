...
namespace Landis.Biomass.Succession
{
        ...
        : Landis.Succession.PlugIn
    {
        ...
        {
            //TotalSiteDefoliation.Method = TotalSiteDefoliation.DefaultMethod;
            
            base.InitializeSites(initialCommunities, initialCommunitiesMap);
            
            //After initialization, access methods in the insects extension:
            //CohortDefoliation.Compute = Insects.PlugIn.GrowthLossTranslator;
            //TotalSiteDefoliation.Method = Insects.PlugIn.GetTotalSiteDefoliation;
        }
