...
namespace Landis.Biomass.Succession
{
    ...
    public class CohortBiomass
        : LivingBiomass, Biomass.ICalculator//, Biomass.IGrowthReduction
    {
                                 ...
                                 int        prevYearSiteMortality)
        {
            ...
            //ANPP_ACT_ij *= Biomass.CohortDefoliation.GetCohortDefoliation(cohort, site);
        ...
        /// </summary>
        /// <param name="cohort">
        /// The cohort whose biomass the non-woody % is to be computed for.
        /// </param>
        /// <param name="site">
        /// The site where the cohort is located.
        /// </param>
                                                    ...
                                                    ActiveSite site)
        {
            ...
            return ComputeNonwoodyPercentage();
        }
                                         ...
                                         int        prevYearSiteMortality)
        {
            ...
            ComputeActualANPP(siteBiomass, prevYearSiteMortality, percentDefoliation);

            if (isDebugEnabled)
                log.DebugFormat("site {0}: biomass = {1}, cohort = ({2}, {3}), % defoliation = {4}",
                                site.Location, siteBiomass, species.Name, cohort.Biomass, percentDefoliation);
                                       ...
                                       double percentDefoliation)
        {
            ...
            //  Species can use new space from last year's mortality immediately
            ...
            if (percentDefoliation > 0)
                ANPP_ACT_ij *= (1.0 - percentDefoliation);
