...
namespace Landis.AgeOnly.Succession
{
	                                       ...
	                                       Cohorts.ISuccession<AgeOnly.ICohort>
	{
		...
		public void Initialize(string dataFile)
		{
			...
			SiteVars.Initialize();
			AgeOnly.Cohort.Died = CohortDeath;
		}
		...
		public void CohortDeath(ICohort    cohort,
		                        ActiveSite site)
		{
			//if (Reproduction.Resprout(cohort, site))
			//	Landis.Succession.SiteVars.Reproduction[site].Resprout(cohort.Species);
			//
			//or
			//
			//CheckForResprouting(cohort, site);  <-- in base class
		}
