//  Copyright 2007 - 2008 Conservation Biology Institute
...
namespace Landis.Extension.Succession.Century
{
    ...
    public class ParametersParser
        : Dynamic.BiomassParametersParser<IParameters>
    {
                   ...
                   speciesDataset)
        {
            ...
            Dynamic.InputValidation.Initialize(startYear, endYear);
        }
        ...
        protected override IParameters Parse()
        {
            ...
            UI.WriteLine(" Begin parsing FUNCTIONAL GROUP table.");
            ...
            while (! AtEndOfInput && CurrentName != InitialEcoregionParameters) {
                ...
                //UI.WriteLine("PPRPTS2={0}.", parameters.FunctionalTypeTable[ln].PPRPTS2);
            ...
            UI.WriteLine(" Begin reading INITIAL ECOREGION parameters.");
            ...
            UI.WriteLine(" Begin reading FIXED ECOREGION parameters.");
            ...
            while (! AtEndOfInput && CurrentName != Names.FireReductionParameters ) {
                ...
                //ReadValue(anp, currentLine);
                //parameters.SetMonthlyNDeposition(ecoregion, anp.Value);
                ...
                CheckNoDataAfter("the " + lat.Name + " column", currentLine);
                
                GetNextLine();
            }
            //--------- Read In Fire Reductions Table ---------------------------
            UI.WriteLine(" Begin reading FIRE REDUCTION parameters.");
