...
namespace Landis.Extension.Succession.Century
{
    ...
    public class SoilWater
    {
        ...
        public static void Run(int year, int month, double liveBiomass, ActiveSite site)
        {
            ...
            //UI.WriteLine("potentialEvapTop={0}, remainingPET={1}, transpiration={2}, evaporativeLoss={3}.",potentialEvapTop,remainingPET,transpiration,evaporativeLoss);
            ...
            //UI.WriteLine("Yr={0},Mo={1}, soilWaterContent={2:0.0}, oldSWC={3:0.0}, addToSoil={4:0.0}.", year, month, soilWaterContent,SiteVars.SoilWaterContent[site],addToSoil);
            ...
            //UI.WriteLine("Yr={0},Mo={1}, soilWaterContent={2:0.0}.", year, month, soilWaterContent);
            ...
            //UI.WriteLine("Yr={0},Mo={1}, evapLossTop={2:0.0}, evmt={3:0.00}, potentialEvapTop={4:0.0}, bareSoilEvap={5}.", year, month, evapLossTop, evmt, potentialEvapTop, bareSoilEvap);
            ...
            //UI.WriteLine("Yr={0},Mo={1}, availableH20={2:0.00}, evapLossTop={3:0.00}.", year, month,availableWater, evapLossTop);
        ...
        {       
            ...
            //UI.WriteLine("Month={0}, DecayFactor={1:0.00}, tempFactor={2:0.00}, waterFactor={3:0.00}, ratioPrecipPET={4:0.000}.", month+1,decayFactor, tempModifier, W_Decomp, ratioPrecipPET);
