        ...
        public static void CalculateMineralNfraction(Site site)
        {
            ...
            foreach (ISpeciesCohorts speciesCohorts in SiteVars.Cohorts[site])
            {
                ...
                foreach (ICohort cohort in speciesCohorts)
                {
                    ...
                    PlugIn.ModelCore.Log.WriteLine("Yr={0},Mo={1}. MineralNfraction={2:0.00}", PlugIn.ModelCore.CurrentTime, Century.Month, CohortMineralNfraction[cohort.Species.Index][cohortAddYear]);
                }
            }
