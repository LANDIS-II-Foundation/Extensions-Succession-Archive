...
//  Author: Robert Scheller, Ben Sulman, Melissa Lucash, Fugui Wang
...
namespace Landis.Extension.Succession.Century
{
    ...
    public class SoilWater
    {
        public static void Run(int year, int month, double liveBiomass, Site site, out double baseFlow, out double stormFlow)
        {
            ...
            double deadBiomass = SiteVars.SurfaceDeadWood[site].Carbon * 2.0 + SiteVars.SurfaceDeadBranch[site].Carbon * 2.0 + SiteVars.SurfaceDeadBranchR[site].Carbon * 2.0;//wang
