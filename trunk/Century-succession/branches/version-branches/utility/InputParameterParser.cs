        ...
        : Dynamic.BiomassParametersParser<IInputParameters>
    {
        ...
        protected override IInputParameters Parse()
        {
            ...
            while (! AtEndOfInput && CurrentName != InitialEcoregionParameters) {
                ...
                //wang
                ReadValue(fcbranch, currentLine);
                funcTParms.FCFRACbranch= fcbranch.Value;
                ...
                //wang
                ReadValue(mbm, currentLine);
                funcTParms.MonthlyBranchMortality = mbm.Value;
            ...
            while (!AtEndOfInput && CurrentName != Names.MonthlyMaxNPP && CurrentName != Names.HarvestReductionParameters)
            {
                ...
                ReadValue(bred, currentLine);
                inputFireReduction.BranchReduction = bred.Value;
