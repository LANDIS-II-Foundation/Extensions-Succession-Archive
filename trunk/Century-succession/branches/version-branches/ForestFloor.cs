...
namespace Landis.Extension.Succession.Century
{
    ...
    public class ForestFloor
    {
        ...
        /// Adds some biomass for a species to the WOOD litter pools at a site.
        /// </summary>
        public static void AddBranchRLitter(double branchBiomass,
                                    ISpecies species,
                                    ActiveSite site)
        {
            ...
            if (branchBiomass > 0)
                WoodLayer.PartitionResidue(branchBiomass,
                                FunctionalType.Table[SpeciesData.FuncType[species]].BranchRDecayRate,
                                SpeciesData.BranchRCN[species],
                                SpeciesData.BranchRLignin[species],
                                LayerName.BranchR,
                                LayerType.Surface,
                                site);
