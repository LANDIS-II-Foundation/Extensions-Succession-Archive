...
namespace Landis.Biomass.NuCycling.Succession.DynamicChange
{
    ...
    public class ParametersUpdate
    {
        ...
        /// </remarks>
        public IInputParameters Parameters
        {
            get {
                return parameters;
            }
        ...
        /// </param>
        public void LoadParameters(ITextParser<IInputParameters> parameterParser)
        {
            parameters = Landis.Data.Load<IInputParameters>(file, parameterParser);
        }
    }
}
