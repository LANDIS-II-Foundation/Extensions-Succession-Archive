...
#define ExtInfoFile "Age-only Succession 4.1.txt"
...
Source: {#LandisExtDir}\Landis.Library.Succession.dll; DestDir: {app}\bin\extensions; Flags: uninsneveruninstall replacesameversion
Source: {#LandisExtDir}\Landis.Library.Cohorts.dll; DestDir: {app}\bin\extensions; Flags: uninsneveruninstall replacesameversion
Source: {#LandisExtDir}\Landis.Library.AgeOnlyCohorts.dll; DestDir: {app}\bin\extensions; Flags: uninsneveruninstall replacesameversion
