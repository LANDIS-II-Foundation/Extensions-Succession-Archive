...
namespace Landis.Extension.Succession.Century
{
    ...
    public class SoilWater
    {
        ...
        public static void Run(int year, int month, double liveBiomass, ActiveSite site)
        {
            ...
            //UI.WriteLine("year = {0}, month = {1}", year, month);
            ...
            //RMS: UI.WriteLine("Yr={0},Mo={1}, *************************************", year, month);
            //RMS: UI.WriteLine("Yr={0},Mo={1}, H20input={2:0.0}, tave={3:0.0}, SWC={4:0.0}, litter={5:0.0}, live={6:0.0}", year, month, H2Oinputs, tave, soilWaterContent, litterBiomass, liveBiomass);
            ...
            {   
                ...
                //UI.WriteLine("bareSoilEvap={0}, litterBiomass={1}, standingBiomass={2}.", bareSoilEvap, litterBiomass, standingBiomass);
                ...
                //RMS: UI.WriteLine("Yr={0},Mo={1}, evaporativeLoss={2:0.0}, addToSoil={3:0.0}, remainingPET={4:0.0}", year, month, evaporativeLoss, addToSoil, remainingPET);
            ...
            //RMS: UI.WriteLine("Yr={0},Mo={1}, PotentialEvapTop={2:0.0}, remainingPET={3:0.0}, transpiration={4:0.0}, evaporativeLoss={5:0.0}.", year, month, potentialEvapTop, remainingPET, transpiration, evaporativeLoss);
            ...
            //RMS: UI.WriteLine("Yr={0},Mo={1}, tran={2:0.0}, transpiration={3:0.0}, addToSoil={4:0.00}.", year, month, tran, transpiration, addToSoil);
            ...
            //RMS: UI.WriteLine("Yr={0},Mo={1}, soilWaterContent={2:0.0}, addToSoil={3:0.0}.", year, month, soilWaterContent,addToSoil);
            ...
            {
                //RMS: UI.WriteLine("Yr={0},Mo={1}, soilWaterContent > waterFull", year, month); 
            ...
            //RMS: UI.WriteLine("Yr={0},Mo={1}, availableWater={2:0.0}, soilWaterContent={3:0.0}.", year, month, availableWater, soilWaterContent);
            ...
            if(availableWaterWeighted > 0.0) 
            {
                ...
                //for( j = 0; j < nlayer; j++)
                 ...
                 //RMS: UI.WriteLine("Yr={0},Mo={1}, availableWater={2:0.0}, SWC={3:0.0}", year, month, availableWater, soilWaterContent);
                ...
                //RMS: UI.WriteLine("Yr={0},Mo={1}, TranspirationLoss={2:0.0}, availableWater={3:0.0}, soilwaterContent={4:0.00}, relativeWaterContent={5:0.00}.", year, month, transpirationLoss, availableWater, soilWaterContent, relativeWaterContent);
            ...
            //UI.WriteLine("evmt={0:0.0}, relativeWaterContent={1:0.00}, fwlos={2}.", evmt,relativeWaterContent,fwlos);
            ...
            //RMS: UI.WriteLine("Yr={0},Mo={1}, evapLossTop={2:0.00}, SWC={3:0.00}", year, month, evapLossTop, soilWaterContent);
            ...
            //RMS: UI.WriteLine("Yr={0},Mo={1}, soilwaterContent={2:0.00}, relativeWaterContent={3:0.00}.", year, month,soilWaterContent, relativeWaterContent);

            // Compute the ratio of precipitation to PET
            double ratioPrecipPET = 0.0;
            if(pet > 0.0)  ratioPrecipPET = (availableWater + H2Oinputs) / pet;
            
            //UI.WriteLine("ratioPrecipPET={0}, totalAvailableH20={1}, H2Oinputs={2}, pet={3}.", ratioPrecipPET, totalAvailableWater, H2Oinputs, pet);
            ...
            //UI.WriteLine("availH2O={0}, soilH2O={1}, wiltP={2}, soilCM={3}", availableWater, soilWaterContent, wiltingPoint, soilDepth);
            //UI.WriteLine("   yr={0}, mo={1}, DecayFactor={2:0.00}, Anaerobic={3:0.00}.", year, month, SiteVars.DecayFactor[site], SiteVars.AnaerobicEffect[site]);
        ...
        {       
            ...
            //RMS: UI.WriteLine("Yr={0},Mo={1}, DecayFactor={2:0.00}, tempFactor={3:0.00}, waterFactor={4:0.00}, ratioPrecipPET={5:0.000}, soilT={6:0.0}.", 99, month, decayFactor, tempModifier, W_Decomp, ratioPrecipPET, soilTemp);
        ...
        private static double CalculateSoilTemp(double tmin, double tmax, double liveBiomass, double litterBiomass, int month)
        {
            ...
            //UI.WriteLine("Month={0}, Soil Temperature = {1}.", month+1, soilTemp);
            
            return soilTemp;
        }
        //--------------------------------------------------------------------------
        public static void Leach(ActiveSite site)//, double baseFlow) 
        ...
        {       //Originally from leach.f of CENTURY model
            ...
            double stormFlow = 0.0; //SiteVars.StormFlow[site];
            ...
            if (waterMove > 0.0 && SiteVars.MineralN[site] > 0.0)
            {
                ...
                //UI.WriteLine("amtLeach={0:0.0}, fractionLeach={1:0.0}, leachIntensity={2:0.0}, stormF={3}.", amtLeached, fractionLeach, leachIntensity, stormFlow);
