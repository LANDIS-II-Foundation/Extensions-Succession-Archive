...
namespace Landis.Extension.Succession.Century
{
    ...
    public class Century
    {
                                       ...
                                       bool        isSuccessionTimeStep)
        {
            ...
            for (int y = 0; y < years; ++y) {
                ...
                for (int i = 0; i < 12; i++)
                {
                    ...
                    double liveBiomass = (double) ComputeLivingBiomass(site);
                    ...
                    if(month==11)
                        SiteVars.SiteCohorts[site].Grow(site, (y == years && isSuccessionTimeStep), true);
                    else
                        SiteVars.SiteCohorts[site].Grow(site, (y == years && isSuccessionTimeStep), false);
            ...
            ComputeTotalCohortCN(site);

            return SiteVars.SiteCohorts[site];
        }
        //---------------------------------------------------------------------

        private static int ComputeLivingBiomass(ActiveSite site)
        {
            int total = 0;
            //if (cohorts != null)
        ...
        //---------------------------------------------------------------------
        private static void ComputeTotalCohortCN(ActiveSite site)
        {
