        ...
        : Biomass.ICalculator
    {
                                         ...
                                         double[]   mortalityAge)
        {
            ...
            if(Model.Core.CurrentTime > 0 && OtherData.CalibrateMode)
            {
                ...
                UI.WriteLine("Yr={0},Mo={1}.     LIMITS:   T={2:0.00}", Model.Core.CurrentTime, month+1, limitT);
        ...
        /// </summary>
        private double[] ComputeGrowthMortality(ICohort cohort)
        {
        ...
        /*private double calculateN_Limit(ActiveSite site, ICohort cohort)
        {
            double leafFractionNPP = 0.0;

            double Nreduction = AvailableN.CohortUptakeAvailableN(adjustedNPP, site, cohort, leafFractionNPP);
