        ...
        : Landis.Library.LeafBiomassCohorts.ICalculator
    {
        ...
        public float[] ComputeChange(ICohort cohort, ActiveSite site)
        {
            ...
            if (Century.Month == 6)  //July = 6
            {
                ...
                //defoliation = Landis.Library.Biomass.CohortDefoliation.Compute(cohort, site, (int)siteBiomass);
                defoliation = Landis.Library.Biomass.CohortDefoliation.Compute(site, cohort.Species, cohort.Biomass, (int)siteBiomass);
