...
Source: {#LandisBuildDir}\biomass-cohort\build\release\Landis.Biomass.Cohorts.dll; DestDir: {app}\bin
Source: {#LandisBuildDir}\dead-biomass\build\release\Landis.Biomass.Dead.dll; DestDir: {app}\bin
Source: {#LandisBuildDir}\biomass-succession-v1\build\release\Landis.Biomass.Succession.dll; DestDir: {app}\bin
...
Source: {#LandisBuildDir}\output-biomass\build\release\Landis.Output.Biomass.dll; DestDir: {app}\bin
Source: {#LandisBuildDir}\output-biomass\deploy\docs\LANDIS-II Biomass Output v1.2 User Guide.pdf; DestDir: {app}\doc

#define BiomassOutput "Output Biomass 1.2.txt"
Source: {#BiomassOutput}; DestDir: {#LandisPlugInDir}

; Biomass Reclass v1.0 plug-in
Source: {#LandisBuildDir}\biomass-reclass\build\release\Landis.Output.BiomassReclass.dll; DestDir: {app}\bin
Source: {#LandisBuildDir}\biomass-reclass\deploy\docs\LANDIS-II Biomass Reclass Output v1.0 User Guide.pdf; DestDir: {app}\doc
...
Source: {#LandisBuildDir}\biomass-succession-v1\deploy\examples\*; DestDir: {app}\examples; Flags: recursesubdirs
