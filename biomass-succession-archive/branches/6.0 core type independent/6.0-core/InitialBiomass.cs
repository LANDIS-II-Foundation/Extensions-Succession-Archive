...
namespace Landis.Extension.Succession.Biomass
{
    ...
    public class InitialBiomass
    {
        ...
        private static IDictionary<ushort, List<Landis.Library.BaseCohorts.ICohort>> sortedCohorts;
        ...
        static InitialBiomass()
        {
            ...
            sortedCohorts = new Dictionary<ushort, List<Landis.Library.BaseCohorts.ICohort>>();
        }
                                             ...
                                             ICommunity initialCommunity)
        {
            ...
            List<Landis.Library.BaseCohorts.ICohort> sortedAgeCohorts;
        ...
        /// oldest to youngest.
        /// </summary>
        public static List<Landis.Library.BaseCohorts.ICohort> SortCohorts(Landis.Library.BaseCohorts.ISiteCohorts siteCohorts)
        {
            List<Landis.Library.BaseCohorts.ICohort> cohorts = new List<Landis.Library.BaseCohorts.ICohort>();
            foreach (Landis.Library.BaseCohorts.ISpeciesCohorts speciesCohorts in siteCohorts)
            {
                foreach (Landis.Library.BaseCohorts.ICohort cohort in speciesCohorts)
                    cohorts.Add(cohort);
            }
            cohorts.Sort(Landis.Library.BaseCohorts.Util.WhichIsOlderCohort);
            return cohorts;
        }
        ...
        /// </param>
        public static SiteCohorts MakeBiomassCohorts(List<Landis.Library.BaseCohorts.ICohort> ageCohorts,
                                                     ActiveSite site,
                                                     ComputeMethod initialBiomassMethod)
        {
            SiteCohorts biomassCohorts = new SiteCohorts();
            SiteVars.Cohorts[site] = biomassCohorts;
            ...
            for (int time = -(ageCohorts[0].Age); time <= endTime; time += successionTimestep)
            {
                ...
                PlugIn.GrowCohorts(biomassCohorts, site, successionTimestep, true);
                       ...
                       ageCohorts[indexNextAgeCohort].Age == -time)
                {
                    ...
                    int initialBiomass = initialBiomassMethod(species, biomassCohorts, site);
        ...
        public static SiteCohorts MakeBiomassCohorts(
                                                     List<Landis.Library.BaseCohorts.ICohort> ageCohorts,
                                                     ActiveSite site)
        {
