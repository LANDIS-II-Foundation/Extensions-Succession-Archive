...
namespace Landis.Biomass.Succession.ClimateChange
{
        ...
        : IParameters
    {
        ...
        //private Species.AuxParm<double> growthR;
        ...
        //---------------------------------------------------------------------
/*
        public Species.AuxParm<double> GrowthR
        {
            get {
                return growthR;
            }
        ...
        //---------------------------------------------------------------------
/*
        public void SetGrowthR(ISpecies           species,
                                          InputValue<double> newValue)
        {
            Debug.Assert(species != null);
            growthR[species] = CheckBiomassParm(newValue, 0.0, 1.0);
        }*/
        //---------------------------------------------------------------------
